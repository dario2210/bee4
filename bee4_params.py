...
# WFO parameter grid
WT_CHANNEL_LEN_GRID = [8, 10, 12]
WT_AVG_LEN_GRID = [14, 21, 28]
WT_SIGNAL_LEN_GRID = [3, 4]
WT_MIN_SIGNAL_LEVEL_GRID = [0.0, 10.0]
WT_REENTRY_WINDOW_GRID = [1, 2, 3]
WT_USE_EMA_FILTER_GRID = [False, True]
WT_LONG_ENTRY_MAX_ABOVE_ZERO_GRID = [0.0, 5.0, 10.0]
WT_SHORT_ENTRY_MIN_BELOW_ZERO_GRID = [-10.0, -5.0, 0.0]
