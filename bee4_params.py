...
WT_LONG_ENTRY_MAX_ABOVE_ZERO_GRID = [-60.0, -50.0, -40.0, -30.0]
WT_LONG_ENTRY_MAX_ABOVE_ZERO_OPTIONS = [-60.0, -50.0, -40.0, -30.0]
WT_LONG_CLOSE_MIN_LEVEL_GRID = [40.0, 50.0]
WT_LONG_CLOSE_MIN_LEVEL_OPTIONS = [40.0, 50.0]
WT_SHORT_ENTRY_MIN_BELOW_ZERO_GRID = [30.0, 40.0, 50.0, 60.0]
WT_SHORT_ENTRY_MIN_BELOW_ZERO_OPTIONS = [30.0, 40.0, 50.0, 60.0]
WT_H4_LONG_FILTER_MAX_GRID = [-50.0, -40.0, -30.0, -20.0, -10.0]
WT_H4_LONG_FILTER_MAX_OPTIONS = [-50.0, -40.0, -30.0, -20.0, -10.0]
WT_H4_LONG_CLOSE_MIN_GRID = [30.0, 40.0, 50.0]
WT_H4_LONG_CLOSE_MIN_OPTIONS = [30.0, 40.0, 50.0]
...
def load_params() -> dict:
    ...
    # BEE4_4 is temporarily long-only. Keep this enforced even when older WFO
