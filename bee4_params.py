...
WT_LONG_TP1_PCT_GRID = [0.008, 0.01, 0.012]
WT_LONG_TP1_PCT_OPTIONS = [0.008, 0.01, 0.012]
WT_LONG_TP2_PCT_GRID = [0.015, 0.02, 0.025, 0.03]
WT_LONG_TP2_PCT_OPTIONS = [0.015, 0.02, 0.025, 0.03]
WT_LONG_TP1_FRACTION_GRID = [0.25, 1.0 / 3.0, 0.5]
WT_LONG_TP1_FRACTION_OPTIONS = [0.25, 1.0 / 3.0, 0.5]
WT_LONG_TP2_FRACTION_GRID = [0.25, 1.0 / 3.0, 0.5]
WT_LONG_TP2_FRACTION_OPTIONS = [0.25, 1.0 / 3.0, 0.5]
